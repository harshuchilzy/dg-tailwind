...
echo $productBrandTerm[0]->name;
									...
									<div class="home-product-detail p-5">
										...
										<a href="<?php echo get_permalink($product_id); ?>"><?php the_title( '<h3 class="title-color font-normal text-base mb-4">', '</h3>' ); ?></a>
										<div class="home-product-shipping grid grid-cols-2 grid-flow-row gap-4">
											<div class="hps-left flex items-center gap-3">
												<span class="shadow shadow-gray-300 bg-white px-2">
												    ...
												    <img src="<?php echo get_site_url(); ?>/wp-content/themes/tailpress/images/truck.png" alt="" class="w-6"></span>
											    <?php 
                                      ...
                                      <?php } ?>
                                         ...
                                         ?> 
											<div class="hps-right">
												<h5 class="text-xs title-color font-normal text-left">Nu bested, <?php echo $age[date('D', strtotime($date. ' + 4 days'))]; ?> bezorgd</h5>
											</div>	
										</div>
										<div class="home-product-bottom flex items-center justify-between mt-4">
											<div class="home-product-price">
												<h4 class="text-black font-bold text-base"><?php echo $product->get_price_html(); ?></h4>
											...
											<div class="flex gap-1 add-cart">
												...
												<div class="actiondiv">
												<a href="?add-to-cart=<?php echo $product->get_id(); ?>" data-quantity="1" class="px-8 py-1 rounded-sm uppercase text-sm bg-orange text-white font-normal hover:bg-black add_to_cart_button ajax_add_to_cart" data-product_id="<?php echo $product->get_id(); ?>" data-product_sku="<?php echo $product->get_sku(); ?>" aria-label="Add “WC haakje Stout RVS 47x16mm” to your cart" rel="nofollow">bestel</a></div>
