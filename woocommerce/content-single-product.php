...
<div class="product-page">
			...
			<div class="flex gap-8">
				...
				<img src="' . $Original_image_url . '" width="100" height="100">
					...
					<div class="product-left-bottom-block">
						...
						$postId3 = get_field('article_3');
						$postTitle3 = get_post($postId3)->post_title;
						$postLink3 = get_permalink($postId3);
						$postDate3 = get_the_time('d/m/Y', $postId3);
						$postImage3 = wp_get_attachment_url(get_post_thumbnail_id($postId3));
						$excerpt3 = get_the_excerpt($postId3);
						$postId4 = get_field('article_4');
						$postTitle4 = get_post($postId4)->post_title;
						$postLink4 = get_permalink($postId4);
						$postDate4 = get_the_time('d/m/Y', $postId4);
						$postImage4 = wp_get_attachment_url(get_post_thumbnail_id($postId4));
						$excerpt4 = get_the_excerpt($postId4);
						$postId5 = get_field('article_5');
						$postTitle5 = get_post($postId5)->post_title;
						$postLink5 = get_permalink($postId5);
						$postDate5 = get_the_time('d/m/Y', $postId5);
						$postImage5 = wp_get_attachment_url(get_post_thumbnail_id($postId5));
						$excerpt5 = get_the_excerpt($postId5);
						?>
						<?php if ($postId) { ?>
						...
						<?php }
						if ($postId3) { ?>
							<a href="<?php echo $postLink3; ?>" class="plbb-block">
								<div class="plbb-block-left">
									<img src="<?php echo $postImage3; ?>" alt="">
								</div>
								<div class="plbb-block-right">
									<h3><?php echo $postTitle3; ?></h3>
									<span><?php echo $postDate3; ?></span>
									<p><?php echo $excerpt3; ?></p>
									<span class="heart-icon">
										<img src="<?php echo get_site_url(); ?>/wp-content/themes/tailpress/images/heart.png" alt="">
									</span>
								</div>
						...
						<?php }
						if ($postId4) { ?>
							<a href="<?php echo $postLink4; ?>" class="plbb-block">
								<div class="plbb-block-left">
									<img src="<?php echo $postImage4; ?>" alt="">
								</div>
								<div class="plbb-block-right">
									<h3><?php echo $postTitle4; ?></h3>
									<span><?php echo $postDate4; ?></span>
									<p><?php echo $excerpt4; ?></p>
									<span class="heart-icon">
										<img src="<?php echo get_site_url(); ?>/wp-content/themes/tailpress/images/heart.png" alt="">
									</span>
								</div>
						...
						<?php }
						if ($postId5) { ?>
							<a href="<?php echo $postLink5; ?>" class="plbb-block">
								<div class="plbb-block-left">
									<img src="<?php echo $postImage5; ?>" alt="">
								</div>
								<div class="plbb-block-right">
									<h3><?php echo $postTitle5; ?></h3>
									<span><?php echo $postDate5; ?></span>
									<p><?php echo $excerpt5; ?></p>
									<span class="heart-icon">
										<img src="<?php echo get_site_url(); ?>/wp-content/themes/tailpress/images/heart.png" alt="">
									</span>
								</div>
	...
	<div class="real-img-section m-5 p-5">
		<div class="container mx-auto">
			<div class="grid row-auto">
				<div class="grid grid-cols-2 gap-4">
					<div class="real-image-gallery">
						<?php
						$images = get_field('real_pictures');
						if ($images) : ?>
							<?php foreach ($images as $image) : ?>
								<?php $image_large = wp_get_attachment_image_src($image['id'], 'large'); ?>
								<?php $image_thb = wp_get_attachment_image_src($image['id'], 'medium', $image['caption']); ?>

								<div class="real-caresol eventGal">
									<a href="<?php echo $image_large[0]; ?>" rel="lightbox[gallery]">
										<img src="<?php echo $image_thb[0]; ?>" class="attachment-medium" /></a>
								</div>
							<?php endforeach; ?>
						<?php endif; ?>
					</div>
					<div class="real-img-textarea">
						<h1 class="text-lg font-normal uppercase text-black"><? echo get_field('real_picture_title') ?></h1>
						<p class="text-sm font-normal title-color">
							<? echo get_field('real_picture_paragraph') ?>
						</p>
					</div>
				</div>
			</div>
